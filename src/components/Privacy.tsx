...
export default function Privacy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 prose dark:prose-invert">
      ...
      <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to ebookcc.</p></li>
      ...
      <li><p><strong>Country/State</strong> refers to: New York, United States.</p></li>
      ...
      <li><p><strong>Personal Data</strong> (or "Personal Information") is any information that relates to an identified or identifiable individual.</p>
      <p>We use "Personal Data" and "Personal Information" interchangeably unless a law uses a specific term.</p></li>
      ...
      <li><p><strong>Website</strong> refers to ebookcc, accessible from <a href="https://ebookcc.com" rel="external nofollow noopener" target="_blank">https://ebookcc.com</a>.</p></li>
      ...
      <p>Administered by: Us</p>
      <p>Purpose: These Cookies identify whether users have accepted the use of cookies on the Website.</p></li>
      ...
      <ul>
      <li>By email: support@ebookcc.com</li>
      </ul>
    </div>
  );
}
